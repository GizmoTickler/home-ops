...
func TestTalosTemplatesUseClusterConfig(t *testing.T) {
	...
	assert.Contains(t, controlplane, "factory.talos.dev/installer/c682c3b7e2747ecadb2b2f9eb73336e40373cfbe6f7ec588336ece6f3a1059cf:v1.13.7")
	assert.Contains(t, controlplane, "image: ghcr.io/siderolabs/kubelet:v1.36.3")
